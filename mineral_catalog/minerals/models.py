...
class Mineral(models.Model):
    ...
    strunz_classification = models.CharField(max_length=255, blank=True, null=True)
    ...
    mohs_scale_hardness = models.CharField(max_length=255, blank=True, null=True)
    ...
    optical_properties = models.CharField(max_length=255, blank=True, null=True)
